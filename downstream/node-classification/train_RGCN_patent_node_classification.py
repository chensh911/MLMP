...
args = {'dataset': 'GoodReads',
        ...
        'optimizer': 'adam', 'weight_decay': 0, 'epochs': 500, 'patience': 50}
args['data_path'] = os.path.join("../../data/", args['dataset'], "model" ,f"{args['embedding_name']}.pkl")
args['data_split_idx_path'] = os.path.join("../../data/", args['dataset'], "downstream" ,"node_split_idx.pkl")
...
if __name__ == '__main__':
    ...
    if args['mode'] == 'train':
        ...
        params = torch.load(f"../save_model/{args['dataset']}/RGCN/{args['embedding_name']}/RGCN.pkl", map_location='cpu')
    ...
    save_result_path = os.path.join(save_result_folder,
                                    f"{args['dataset']}_emb_{args['embedding_name']}.json")
