...
if __name__ == '__main__':
    ...
    if args['mode'] == 'train':
        ...
        params = torch.load(f"save_model/{args['dataset']}/{args['model_name']}/{args['embedding_name']}/HetSANN.pkl", map_location='cpu')
    ...
    save_result_path = os.path.join(save_result_folder, f"{args['dataset']}_{args['embedding_name']}.json")
