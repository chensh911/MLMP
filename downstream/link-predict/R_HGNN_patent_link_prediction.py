...
args = {
    'dataset': 'GoodReads',
    'model_name': 'R_HGNN_link_prediction',
...
if __name__ == '__main__':
    ...
    save_result_path = os.path.join(save_result_folder, f"{args['embedding_name']}_{args['dataset']}_{args['model_name']}.json")
