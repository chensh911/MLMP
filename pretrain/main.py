...
parser.add_argument("--model_dir", type=str, default='ckpt/OAG_Venue', choices=['ckpt/OAG_Venue', 'ckpt/GoodReads', 'ckpt/Patents'])  # path to save
...
parser.add_argument("--max_length", type=int, default=72) # this parameter should be the same for all models for one particular dataset
...
parser.add_argument("--graph_layers", type=int, default=3)  # number of layer
