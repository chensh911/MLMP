...
CUDA_VISIBLE_DEVICES=5 python main.py --feats 3 --data_path $FOLDER/$DATASET --pretrain_embed True --pretrain_dir $FOLDER/$DATASET/pretrain_embed
CUDA_VISIBLE_DEVICES=5 python main.py --feats 3 --data_path $FOLDER/$DATASET --pretrain_embed True --pretrain_dir $FOLDER/$DATASET/pretrain_embed --mode infer --load True --load_ckpt_name ckpt/OAG_Venue/text-True-6e-05-100-768-tfidf-best-nograph.pt
